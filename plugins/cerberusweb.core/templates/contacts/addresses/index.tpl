...
<tr>
	<td width="1%" nowrap="nowrap" valign="top" style="padding-right:5px;">
		...
		{if $active_worker->hasPriv('core.addybook.addy.actions.update')}
			<button type="button" onclick="genericAjaxPanel('c=contacts&a=showAddressPeek&id=0&org_id={$contact->id}&view_id={$view->id}',this,false,'500px',ajax.cbAddressPeek);"><img src="{devblocks_url}c=resource&p=cerberusweb.core&f=images/businessman_add.gif{/devblocks_url}" align="top"> {$translate->_('addy_book.address.add')}</button>
		{/if}
		</form>
	</td>
